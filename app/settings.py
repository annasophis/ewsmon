...
PUROLATOR_FREIGHT_ACCOUNT = os.getenv("PUROLATOR_FREIGHT_ACCOUNT", "")
# UAT (cert) creds
...
PUROLATOR_UAT_FREIGHT_ACCOUNT = os.getenv("PUROLATOR_UAT_FREIGHT_ACCOUNT", "")
...
PUROLATOR_FREIGHT_TRACK_PIN_UAT = os.getenv("PUROLATOR_FREIGHT_TRACK_PIN_UAT", "8889768050")
PUROLATOR_FREIGHT_TRACK_PIN = os.getenv("PUROLATOR_FREIGHT_TRACK_PIN", "8889768050")
...
PUROLATOR_DOC_PIN = os.getenv("PUROLATOR_DOC_PIN", "520327338973")
PUROLATOR_DOC_PIN_UAT = os.getenv("PUROLATOR_DOC_PIN_UAT", "720051563792")
# ----------------------------
# Logging
# ----------------------------
